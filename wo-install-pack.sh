...
sleep 3
which wo | echo -e "${CGREEN}WordOps Instalado${CEND}   [${CGREEN}OK${CEND}]"
which fail2ban-client | echo -e "${CGREEN}Fail2ban Instalado${CEND}   [${CGREEN}OK${CEND}]"
which clamscan | echo -e "${CGREEN}clamav Instalado${CEND}   [${CGREEN}OK${CEND}]"
which monit | echo -e "${CGREEN}Monit Instalado${CEND}   [${CGREEN}OK${CEND}]"
which Netdata | echo -e "${CGREEN}Netdata Instalado${CEND}   [${CGREEN}OK${CEND}]" 
which ufw | echo -e "${CGREEN}Firewall-UFW Instalado${CEND}   [${CGREEN}OK${CEND}]"
which mysql | echo -e "${CGREEN}Mysql Instalado${CEND}   [${CGREEN}OK${CEND}]"
which redis | echo -e "${CGREEN}Redis Instalado${CEND}   [${CGREEN}OK${CEND}]"
which nginx | echo -e "${CGREEN}Nginx Instalado${CEND}   [${CGREEN}OK${CEND}]"
...
which php7.2 | echo -e "${CGREEN}PHP-7.2 Instalado${CEND}   [${CGREEN}OK${CEND}]"
which php7.3 | echo -e "${CGREEN}PHP-7.3 Instalado${CEND}   [${CGREEN}OK${CEND}]"
which wp | echo -e "${CGREEN}WP-CLI Instalado${CEND}   [${CGREEN}OK${CEND}]"
